...
class GridFarmLayout(templates.LayoutTemplate):
    """
     a class to take a parameterized structured grid farm and output an actual grid
     for the farm
...
# class GridFarmLanduse(om.ExplicitComponent):
#     """ """
#
#     def initialize(self):
...
#         N_turbines = self.N_turbines = modeling_options["farm"]["N_turbines"]
#
#         self.add_input("spacing_primary", 7.0)
#         self.add_input("spacing_secondary", 7.0)
#         self.add_input("angle_orientation", 0.0, units="deg")
#         self.add_input("angle_skew", 0.0, units="deg")
#         self.add_input("layback_diameters", 0.0, units="unitless")
#
#         self.add_output(
#             "area_tight",
#             0.0,
#             units="m**2",
#             desc="area of the parallelopiped fitted around the farm, plus layback if specified",
#         )
#         self.add_output(
#             "area_aligned_parcel",
#             0.0,
...
#         )
#         lengthscale_spacing_spanwise = inputs["spacing_secondary"] * D_rotor
#         lengthscale_layback = inputs["layback_diameters"] * D_rotor
#
#         N_square = int(np.sqrt(self.N_turbines))  # floors
#
