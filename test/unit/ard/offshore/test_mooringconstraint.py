...
class TestDistancePointToMooring:
    ...
    def test_distance_point_to_mooring_near_end(self):
    ...
    def test_distance_point_to_mooring_near_middle(self):
    ...
    def test_distance_point_to_mooring_near_end_grad(self):
    ...
    def test_distance_point_to_mooring_near_middle_grad(self):
