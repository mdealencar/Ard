...
prob.set_val("aepFLORIS.x", 130.0 * farm_spec["xD_farm"])
prob.set_val("aepFLORIS.y", 130.0 * farm_spec["yD_farm"])

prob.run_model()

print(f"AEP: {prob.get_val('aepFLORIS.AEP_farm', units="GW*h")[0]}")
