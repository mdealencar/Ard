...
wind_rose_wrg = floris.wind_data.WindRoseWRG(os.path.join(os.path.dirname(run_dir), "data", "wrg_example.wrg"))
...
filename_turbine_spec = os.path.join(os.path.dirname(run_dir), "data", "turbine_spec_IEA-3p4-130-RWT.yaml")
